...
/*zokou({nomCom:"vv3",categorie:"General",reaction:"🤭"},async(dest,zk,commandeOptions)=>{
...
zokou({ nomCom: "vv1", aliases: ["send", "keep"], categorie: "new" }, async (dest, zk, commandeOptions) => {
